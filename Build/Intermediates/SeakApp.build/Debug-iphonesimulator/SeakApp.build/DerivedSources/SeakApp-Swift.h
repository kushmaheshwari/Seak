...
SWIFT_CLASS("_TtC7SeakApp11AppDelegate")
...
SWIFT_CLASS("_TtC7SeakApp18CollectionViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified usedLabel;
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified sellerImageView;
...
SWIFT_CLASS("_TtC7SeakApp18HomeViewController")
@interface HomeViewController : UICollectionViewController
@property (nonatomic, copy) NSArray<PFObject *> * _Nonnull items;
@property (nonatomic, copy) NSArray<PFObject *> * _Nonnull searchItems;
...
@property (nonatomic, strong) IBOutlet UICollectionView * _Null_unspecified collectionVieww;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)addItem:(UIButton * _Null_unspecified)sender;
...
@interface HomeViewController (SWIFT_EXTENSION(SeakApp)) <UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC7SeakApp18RegisterController")
@interface RegisterController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified FirstNameTF;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified LastNameTF;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified EmailTF;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified PasswordTF;
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (IBAction)RegisterBtnAction:(id _Nonnull)sender;
- (void)SignUp;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface UIViewController (SWIFT_EXTENSION(SeakApp))
...
SWIFT_CLASS("_TtC7SeakApp14ViewController")
@interface ViewController : UIViewController <FBSDKLoginButtonDelegate>
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified UsernameTF;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified PasswordTF;
...
@property (nonatomic, weak) IBOutlet FBSDKLoginButton * _Null_unspecified FBLoginButton;
- (void)viewDidLoad;
- (void)viewDidLayoutSubviews;
- (void)viewWillAppear:(BOOL)animated;
